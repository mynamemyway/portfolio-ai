...
WELCOME_MESSAGE_TEXT = (
    ...
    "Я — ваш персональный AI-интерфейс к опыту\n"
    "Python-разработчика Александра.\n"
    "Мои базы данных содержат полные стеки,\n"
    "архитектурные решения и детали реализации\n"
    "проекта PrimeNetworking.\n\n"
    "Используйте команды ниже или задайте свой\n"
    "вопрос, чтобы начать извлечение данных."
    "```"
)
