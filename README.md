...
> **Примечание:** Тестирование прототипа выполнено, бот работает, но результаты не устраивают из-за лимитов бесплатного API Mistral. Принято решение провести рефакторинг для перехода на одну из безлимитных моделей от Open Router.
